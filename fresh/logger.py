...
try:
    from fresh.config.production import DEBUG
except:
    from fresh.config.default import DEBUG
...
class LogHandler(object):
    ...
    def _get_handler(cls, log_name, level='INFO'):
        if DEBUG:
            ...
            log_file_name = '{}.log' if level == 'INFO' else '{}_error.log'
...
logger = LogHandler.get_logger('app')